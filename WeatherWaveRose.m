...
custom_start_date = datetime(2023, 01, 1, 0, 0, 0); %Custom start date, do NOT change hourly time 
custom_end_date = datetime(2023, 02, 1, 23, 0, 0);  %Custom start date, do NOT change hourly time
...
for i = 1:length(locations)
    ...
    title(['Weather event: ', full_name, ' (', datestr(custom_start_date), ' 00:00:00', ' - ', datestr(custom_end_date), ')']);
