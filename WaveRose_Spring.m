...
custom_start_date = datetime(2023, 09, 23, 0, 0, 0);  % Custom start date, do NOT change hourly time
custom_end_date = datetime(2023, 12, 21, 23, 0, 0);    % Custom end date, do NOT change hourly time
...
for i = 1:length(locations)
    ...
    WindRose(wave_directions,peak_wave_heights,'ndirections',32,'vwinds',[0 1 2 3 4 5 6 7 8],'titlestring',...
        ['Spring Wave Rose - ', full_name],'lablegend','Significant Wave Height (m)','anglenorth',0,'angleeast',90, ...
