% Load organized data
organized_data = readtable('organized_data_aligned_D_E_Seasons.csv');
...
for i = 1:length(locations)
    ...
    h = heatmap(direction_bins(1:end-1), period_bins_custom{i}(1:end-1), bin_counts, ...
        ...
        'Colormap', cmap);
    title(h, sprintf('Directional Energy Distribution at %s (Total Count: %d)', full_name, total_count));
